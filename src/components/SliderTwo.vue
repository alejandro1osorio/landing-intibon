...
import PageOne from '../../src/components/slideTwo/PageOne.vue';
import PageTwo from '../../src/components/slideTwo/PageTwo.vue';
import PageThree from '../../src/components/slideTwo/PageThree.vue';
