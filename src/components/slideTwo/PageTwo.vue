<template>
  <div class="page-grid">
    ...
    <h1 class="page-title"><strong>Jabón</strong> <strong style="border-bottom: 5px solid #008EB4; font-weight: 300;">íntimo</strong></h1>
    ...
    <div class="image-structure">
      ...
      <div class="image-container">
        ...
        <img src="../../assets/productos/producto2-2.png" alt="Shampoo y Baño Líquido Recién Nacido" style="padding: 0 26px;"/>
