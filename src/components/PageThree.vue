<template>
  <div class="page-grid">
    ...
    <h1 class="page-title">Jabón De <strong style="border-bottom: 5px solid #008EB4; font-weight: 300;">Ropa Intima</strong></h1>
    ...
    <div class="image-structure">
      ...
      <div class="image-container">
        ...
        <img src="../assets/productos/producto1-3.png" alt="Shampoo y Baño Líquido Recién Nacido" style="padding: 0 41px;"/>
